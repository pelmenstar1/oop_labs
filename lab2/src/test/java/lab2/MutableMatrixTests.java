...
public class MutableMatrixTests {
    ...
    public static Stream<Arguments> inverseTestArguments() {
        ...
        var realInputMat2x2 = MutableMatrix.createReal(
            new double[]{-1, 1.5,},
            new double[]{1, -1}
        );

        var realInputMat3x3 = MutableMatrix.createReal(
            new double[]{1, 2, 3},
            new double[]{0, 1, 4},
            new double[]{5, 6, 0}
        );

        var realInputMat4x4 = MutableMatrix.createReal(
            new double[]{1, 2, 3, 4},
            new double[]{6, 7, 8, 9},
        ...
        var realOutputMat2x2 = MutableMatrix.createReal(
            new double[]{2, 3},
            new double[]{2, 2}
        );

        var realOutputMat3x3 = MutableMatrix.createReal(
            new double[]{-24, 18, 5},
            new double[]{20, -15, -4},
            new double[]{-5, 4, 1}
        );

        var realOutputMat4x4 = MutableMatrix.createReal(
